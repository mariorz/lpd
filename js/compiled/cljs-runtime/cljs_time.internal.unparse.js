...
var periods__$1 = cljs.core.vec((function (){var G__58881 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58879_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__58879_SHARP_,(0),(3));
}),G__58881);
} else {
return G__58881;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__58898){
var vec__58900 = p__58898;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58900,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58900,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__58904 = pattern;
switch (G__58904) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__58904)].join('')));
...
switch (G__58914__$1) {
case "millis":
return (function (p1__58906_SHARP_){
return p1__58906_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__58907_SHARP_){
return p1__58907_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__58908_SHARP_){
return p1__58908_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__58909_SHARP_){
return p1__58909_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__58910_SHARP_){
return p1__58910_SHARP_.getHours();
});

break;
case "day":
return (function (p1__58911_SHARP_){
return p1__58911_SHARP_.getDate();
});

break;
case "month":
return (function (p1__58912_SHARP_){
return p1__58912_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__58913_SHARP_){
return p1__58913_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__58914__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__58915){
var vec__58916 = p__58915;
var seq__58917 = cljs.core.seq(vec__58916);
var first__58918 = cljs.core.first(seq__58917);
var seq__58917__$1 = cljs.core.next(seq__58917);
var key = first__58918;
var args = seq__58917__$1;
var G__58919 = key;
var G__58919__$1 = (((G__58919 instanceof cljs.core.Keyword))?G__58919.fqn:null);
switch (G__58919__$1) {
case "millis":
...
break;
case "ordinal-suffix":
var vec__58923 = (function (){var G__58926 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__58926) : syntax_list.call(null,G__58926));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58923,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__58919__$1)].join('')));
...
var d = value;
var G__58931 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__58932 = G__58931;
...
var unparser = first__58934;
var more = seq__58933__$1;
var s = "";
var d__$1 = d;
var G__58931__$1 = G__58931;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__58941 = G__58931__$1;
var seq__58942 = cljs.core.seq(vec__58941);
var first__58943 = cljs.core.first(seq__58942);
var seq__58942__$1 = cljs.core.next(seq__58942);
var unparser__$1 = first__58943;
var more__$1 = seq__58942__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__58944 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58944,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58944,(1),null);
var G__59008 = d__$3;
var G__59009 = more__$1;
var G__59010 = s__$3;
d__$1 = G__59008;
G__58931__$1 = G__59009;
s__$1 = G__59010;
continue;
}
break;
