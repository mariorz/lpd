...
var G__55603 = o;
goog.object.set(G__55603,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__55654__delegate = function (args){
...
while (G__55655__i < G__55655__a.length) {G__55655__a[G__55655__i] = arguments[G__55655__i + 0]; ++G__55655__i;}
  args = new cljs.core.IndexedSeq(G__55655__a,0,null);
} 
return G__55654__delegate.call(this,args);};
G__55654.cljs$lang$maxFixedArity = 0;
G__55654.cljs$lang$applyTo = (function (arglist__55656){
var args = cljs.core.seq(arglist__55656);
return G__55654__delegate(args);
});
...
var G__55604 = o;
goog.object.set(G__55604,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__55660__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__55660 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__55661__i = 0, G__55661__a = new Array(arguments.length -  0);
while (G__55661__i < G__55661__a.length) {G__55661__a[G__55661__i] = arguments[G__55661__i + 0]; ++G__55661__i;}
  args = new cljs.core.IndexedSeq(G__55661__a,0,null);
} 
return G__55660__delegate.call(this,args);};
G__55660.cljs$lang$maxFixedArity = 0;
G__55660.cljs$lang$applyTo = (function (arglist__55662){
var args = cljs.core.seq(arglist__55662);
return G__55660__delegate(args);
});
G__55660.cljs$core$IFn$_invoke$arity$variadic = G__55660__delegate;
return G__55660;
})()
;
} else {
...
var G__55608 = props;
var G__55608__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55608,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__55608);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55608__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__55609 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55609,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__55609;
}
})(),id_class);
...
var G__55613 = (cljs.core.count(argv) - first_child);
switch (G__55613) {
case (0):
...
var vec__55618 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55618,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55618,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55618,(2),null);
...
var temp__5757__auto___55704 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___55704 == null)){
} else {
var key_55709 = temp__5757__auto___55704;
(jsprops.key = key_55709);
}
...
var temp__5757__auto___55718 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___55718 == null)){
} else {
var key_55719 = temp__5757__auto___55718;
(jsprops.key = key_55719);
}
...
var temp__5757__auto___55729 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___55729 == null)){
} else {
var key_55731 = temp__5757__auto___55729;
(jsprops.key = key_55731);
}
...
var temp__5757__auto___55738 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___55738 == null)){
} else {
var key_55740 = temp__5757__auto___55738;
(jsprops.key = key_55740);
}
...
var temp__5757__auto___55744 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___55744 == null)){
} else {
var key_55745 = temp__5757__auto___55744;
(jsprops.key = key_55745);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55630_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__55630_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__55633 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55633,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55633,(1),null);
...
break;
default:
var G__55747 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__55748 = compiler;
v = G__55747;
compiler = G__55748;
continue;
...
var G__55641 = tag;
var G__55641__$1 = (((G__55641 instanceof cljs.core.Keyword))?G__55641.fqn:null);
switch (G__55641__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template55645 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template55645 = (function (opts,id,fn_to_element,meta55646){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.meta55646 = meta55646;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template55645.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55647,meta55646__$1){
var self__ = this;
var _55647__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template55645(self__.opts,self__.id,self__.fn_to_element,meta55646__$1));
}));

(reagent.impl.template.t_reagent$impl$template55645.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55647){
var self__ = this;
var _55647__$1 = this;
return self__.meta55646;
}));

(reagent.impl.template.t_reagent$impl$template55645.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template55645.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template55645.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template55645.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template55645.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta55646","meta55646",-1965350216,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template55645.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template55645.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template55645");

(reagent.impl.template.t_reagent$impl$template55645.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template55645");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template55645.
 */
reagent.impl.template.__GT_t_reagent$impl$template55645 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template55645(opts__$1,id__$1,fn_to_element__$1,meta55646){
return (new reagent.impl.template.t_reagent$impl$template55645(opts__$1,id__$1,fn_to_element__$1,meta55646));
});

}

return (new reagent.impl.template.t_reagent$impl$template55645(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
