shadow$provide.module$node_modules$web3_provider_engine$subproviders$nonce_tracker=function(global,require,module,exports){function NonceTrackerSubprovider(opts){this.nonceCache={}}var Buffer=require("module$node_modules$buffer$index").Buffer;global=require("module$node_modules$util$util").inherits;const Transaction=require("module$node_modules$ethereumjs_tx$es5$index"),ethUtil=require("module$node_modules$ethereumjs_util$dist$index");exports=require("module$node_modules$web3_provider_engine$subproviders$subprovider");
const blockTagForPayload=require("module$node_modules$web3_provider_engine$util$rpc_cache_utils").blockTagForPayload;module.exports=NonceTrackerSubprovider;global(NonceTrackerSubprovider,exports);NonceTrackerSubprovider.prototype.handleRequest=function(payload,next,end){const self=this;switch(payload.method){case "eth_getTransactionCount":var blockTag=blockTagForPayload(payload),address=payload.params[0].toLowerCase(),cachedResult=self.nonceCache[address];"pending"===blockTag?cachedResult?end(null,
...
//# sourceMappingURL=module$node_modules$web3_provider_engine$subproviders$nonce_tracker.js.map
