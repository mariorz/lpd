...
var G__61747 = cljs.tools.reader.reader_types.peek_char(rdr);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__61747)){
...
var vec__61748 = clojure.string.split.cljs$core$IFn$_invoke$arity$3(s,/\s+/,(2));
var prefix = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61748,(0),null);
var rest = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61748,(1),null);
...
try{var map__61752 = re_frisk.filter.filter_parser.read_string_SINGLEQUOTE_(s);
...
var foo = map__61752__$1;
var val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61752__$1,new cljs.core.Keyword(null,"val","val",128701612));
var rest = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61752__$1,new cljs.core.Keyword(null,"rest","rest",-1241696419));
...
try{var map__61763 = re_frisk.filter.filter_parser.read_string_SINGLEQUOTE_(s);
...
var val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61763__$1,new cljs.core.Keyword(null,"val","val",128701612));
var rest = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61763__$1,new cljs.core.Keyword(null,"rest","rest",-1241696419));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"val","val",128701612),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"expr","expr",745722291),val], null),new cljs.core.Keyword(null,"rest","rest",-1241696419),rest], null);
}catch (e61759){var _ = e61759;
var vec__61760 = clojure.string.split.cljs$core$IFn$_invoke$arity$3(s,/\s+/,(2));
var prefix = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61760,(0),null);
var rest = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61760,(1),null);
...
var G__61765 = cljs.core.first(s);
switch (G__61765) {
case "[":
case "(":
case "{":
...
var map__61769 = re_frisk.filter.filter_parser.parse_part(s__$2);
var map__61769__$1 = (((((!((map__61769 == null))))?(((((map__61769.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61769.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__61769):map__61769);
var val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61769__$1,new cljs.core.Keyword(null,"val","val",128701612));
var rest = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61769__$1,new cljs.core.Keyword(null,"rest","rest",-1241696419));
