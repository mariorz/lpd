...
var G__52447 = cljs.core.next(xs);
var G__52448 = cljs.core.next(ys);
xs = G__52447;
ys = G__52448;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__52402 = val;
var G__52403 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__52402,G__52403) : f.call(null,G__52402,G__52403));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__52412 = val__$1;
var G__52413 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__52412,G__52413) : f.call(null,G__52412,G__52413));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__52419 = val__$1;
var G__52420 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__52419,G__52420) : f.call(null,G__52419,G__52420));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__52463 = cljs.core.next(es);
var G__52464 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__52463;
tcoll__$1 = G__52464;
continue;
} else {
...
var G__52465 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__52466 = cljs.core.next(es);
ret = G__52465;
es = G__52466;
continue;
} else {
