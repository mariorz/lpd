...
var len__4736__auto___52707 = arguments.length;
var i__4737__auto___52708 = (0);
while(true){
if((i__4737__auto___52708 < len__4736__auto___52707)){
args__4742__auto__.push((arguments[i__4737__auto___52708]));

var G__52709 = (i__4737__auto___52708 + (1));
i__4737__auto___52708 = G__52709;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq52614){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__52640_SHARP_){
return (!((cljs.core.meta(p1__52640_SHARP_) == null)));
})))){
...
var map__52649 = opts;
var map__52649__$1 = (((((!((map__52649 == null))))?(((((map__52649.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52649.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__52649):map__52649);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52649__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e52660){var _e__52007__auto__ = e52660;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e52663){var _e__52007__auto__ = e52663;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__52668 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__52669 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__52669);

try{var map__52670 = opts;
var map__52670__$1 = (((((!((map__52670 == null))))?(((((map__52670.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52670.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__52670):map__52670);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52670__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__52668);
}});
...
var temp__5751__auto___52748 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___52748)){
var managed_print_level_52749 = temp__5751__auto___52748;
var _STAR_print_level_STAR__orig_val__52679_52750 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__52680_52751 = managed_print_level_52749;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__52680_52751);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__52676_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__52676_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__52679_52750);
}} else {
job_fn();
}
