...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__61219_SHARP_,p2__61220_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__61219_SHARP_,p2__61220_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false));
}),tour_map,tour_spec);
});
/**
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4529__auto__ = (function re_com$tour$initialise_tour_$_iter__61230(s__61231){
return (new cljs.core.LazySeq(null,(function (){
var s__61231__$1 = s__61231;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__61231__$1);
if(temp__5753__auto__){
var s__61231__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__61231__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__61231__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__61233 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__61232 = (0);
while(true){
if((i__61232 < size__4528__auto__)){
var step = cljs.core._nth(c__4527__auto__,i__61232);
cljs.core.chunk_append(b__61233,cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false));

var G__61306 = (i__61232 + (1));
i__61232 = G__61306;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61233),re_com$tour$initialise_tour_$_iter__61230(cljs.core.chunk_rest(s__61231__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61233),null);
}
} else {
var step = cljs.core.first(s__61231__$2);
return cljs.core.cons(cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false),re_com$tour$initialise_tour_$_iter__61230(cljs.core.rest(s__61231__$2)));
}
} else {
return null;
}
...
return cljs.core.reset_BANG_((function (){var fexpr__61254 = cljs.core.first(new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
return (fexpr__61254.cljs$core$IFn$_invoke$arity$1 ? fexpr__61254.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__61254.call(null,tour));
})(),true);
});
/**
...
cljs.core.reset_BANG_((function (){var fexpr__61272 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__61272.cljs$core$IFn$_invoke$arity$1 ? fexpr__61272.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__61272.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__61274 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__61274.cljs$core$IFn$_invoke$arity$1 ? fexpr__61274.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__61274.call(null,tour));
})(),true);
} else {
return null;
}
...
cljs.core.reset_BANG_((function (){var fexpr__61285 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__61285.cljs$core$IFn$_invoke$arity$1 ? fexpr__61285.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__61285.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__61287 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__61287.cljs$core$IFn$_invoke$arity$1 ? fexpr__61287.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__61287.call(null,tour));
})(),true);
} else {
return null;
}
