...
var len__4736__auto___53859 = arguments.length;
var i__4737__auto___53860 = (0);
while(true){
if((i__4737__auto___53860 < len__4736__auto___53859)){
args__4742__auto__.push((arguments[i__4737__auto___53860]));

var G__53861 = (i__4737__auto___53860 + (1));
i__4737__auto___53860 = G__53861;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__53764_53862 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__53765_53863 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__53766_53864 = true;
var _STAR_print_fn_STAR__temp_val__53767_53865 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__53766_53864);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__53767_53865);

try{var _STAR_print_level_STAR__orig_val__53770_53866 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__53771_53867 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__53771_53867);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__53770_53866);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__53765_53863);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__53764_53862);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq53760){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq53760));
}));
...
var new_formatters = current_formatters.filter((function (p1__53809_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__53809_SHARP_)));
}));
...
var G__53815_53893 = f;
var target__52005__auto___53894 = G__53815_53893;
if(cljs.core.truth_(target__52005__auto___53894)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__53815_53893)].join(''),"\n","target__52005__auto__"].join('')));
}

(target__52005__auto___53894["toString"] = (function (){
...
var G__53819_53899 = "%c%s";
var G__53820_53900 = "color:transparent";
var G__53821_53901 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__53819_53899,G__53820_53900,G__53821_53901) : f.call(null,G__53819_53899,G__53820_53900,G__53821_53901));
...
var args__4742__auto__ = [];
var len__4736__auto___53905 = arguments.length;
var i__4737__auto___53906 = (0);
while(true){
if((i__4737__auto___53906 < len__4736__auto___53905)){
args__4742__auto__.push((arguments[i__4737__auto___53906]));

var G__53907 = (i__4737__auto___53906 + (1));
i__4737__auto___53906 = G__53907;
continue;
} else {
}
break;
...
var vec__53832 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53832,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53832,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__53912__delegate = function (add_fmt,add_args){
...
var G__53912 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__53914__i = 0, G__53914__a = new Array(arguments.length -  1);
while (G__53914__i < G__53914__a.length) {G__53914__a[G__53914__i] = arguments[G__53914__i + 1]; ++G__53914__i;}
  add_args = new cljs.core.IndexedSeq(G__53914__a,0,null);
} 
return G__53912__delegate.call(this,add_fmt,add_args);};
G__53912.cljs$lang$maxFixedArity = 1;
G__53912.cljs$lang$applyTo = (function (arglist__53915){
var add_fmt = cljs.core.first(arglist__53915);
var add_args = cljs.core.rest(arglist__53915);
return G__53912__delegate(add_fmt,add_args);
});
G__53912.cljs$core$IFn$_invoke$arity$variadic = G__53912__delegate;
return G__53912;
})()
);
}));
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq53827){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53828,G__53829,G__53830,seq53827__$3);
}));
...
var seq__53842 = cljs.core.seq(features);
var chunk__53843 = null;
var count__53844 = (0);
var i__53845 = (0);
while(true){
if((i__53845 < count__53844)){
var feature = chunk__53843.cljs$core$IIndexed$_nth$arity$2(null,i__53845);
...
var G__53919 = seq__53842;
var G__53920 = chunk__53843;
var G__53921 = count__53844;
var G__53922 = (i__53845 + (1));
seq__53842 = G__53919;
chunk__53843 = G__53920;
count__53844 = G__53921;
i__53845 = G__53922;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__53842);
if(temp__5753__auto__){
var seq__53842__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__53842__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__53842__$1);
var G__53923 = cljs.core.chunk_rest(seq__53842__$1);
var G__53924 = c__4556__auto__;
var G__53925 = cljs.core.count(c__4556__auto__);
var G__53926 = (0);
seq__53842 = G__53923;
chunk__53843 = G__53924;
count__53844 = G__53925;
i__53845 = G__53926;
continue;
} else {
var feature = cljs.core.first(seq__53842__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__53928 = cljs.core.next(seq__53842__$1);
var G__53929 = null;
var G__53930 = (0);
var G__53931 = (0);
seq__53842 = G__53928;
chunk__53843 = G__53929;
count__53844 = G__53930;
i__53845 = G__53931;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5751__auto__)){
var o53854 = temp__5751__auto__;
return (o53854["version"]);
} else {
return null;
}
})() == null);
