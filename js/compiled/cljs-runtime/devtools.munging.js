...
var o52305 = temp__5751__auto__;
var temp__5751__auto____$1 = (o52305["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o52306 = temp__5751__auto____$1;
return (o52306["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__52000__auto__ = f;
return (o__52000__auto__["toString"]).call(o__52000__auto__);
} else {
return "";
}
}catch (e52314){var _ = e52314;
return "";
}});
...
try{var o__52000__auto___52562 = t;
(o__52000__auto___52562["cljs$lang$ctorPrWriter"]).call(o__52000__auto___52562,t,writer);
}catch (e52318){var __52563 = e52318;
}
...
var char_code = (function (){var o__52000__auto__ = (new String(char$));
return (o__52000__auto__["charCodeAt"]).call(o__52000__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__52000__auto__ = String;
return (o__52000__auto__["fromCharCode"]).call(o__52000__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__52333 = num_code;
switch (G__52333) {
case (1):
return (185);
...
var o__52000__auto__ = String;
return (o__52000__auto__["fromCharCode"]).call(o__52000__auto__,superscript_code);
});
/**
...
}catch (e52348){var _e__52007__auto__ = e52348;
return false;
}})())){
...
var vec__52351 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52351,(0),null);
...
var or__4126__auto__ = (function (){var temp__5751__auto__ = cljs.core.re_matches(/(.*)\$/,s);
if(cljs.core.truth_(temp__5751__auto__)){
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__52396){
var vec__52397 = p__52396;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52397,(0),null);
...
var G__52582 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__52583 = cljs.core.butlast(remaining_tokens);
name_tokens = G__52582;
remaining_tokens = G__52583;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq52390){
...
var vec__52406 = cljs.core.split_with((function (p1__52404_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__52404_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52406,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52406,(1),null);
...
var vec__52418 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52418,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52418,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__52589 = cljs.core.rest(remaining_tokens);
var G__52590 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__52589;
name_tokens = G__52590;
continue;
} else {
...
var vec__52432 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52432,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52432,(1),null);
var vec__52435 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52435,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52435,(1),null);
var vec__52438 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52438,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52438,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52438,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52438,(3),null);
...
var vec__52446 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52446,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52446,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52446,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52446,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52446,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52446,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__52450 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52450,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52450,(1),null);
var vec__52453 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52453,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52453,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__52461 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__52461) : devtools.munging.parse_fn_info_deep.call(null,G__52461));
})()));
}
} else {
return fn_info;
...
var G__52598 = (arity + (1));
var G__52599 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__52475){
var vec__52477 = p__52475;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52477,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52477,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52485_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__52485_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52486_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__52486_SHARP_);
}),sorted_infos);
...
var G__52613 = (i__4737__auto___52611 + (1));
i__4737__auto___52611 = G__52613;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__52494){
var vec__52495 = p__52494;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52495,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq52488){
var G__52489 = cljs.core.first(seq52488);
var seq52488__$1 = cljs.core.next(seq52488);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52489,seq52488__$1);
}));
...
var G__52498 = arg;
var G__52498__$1 = (((G__52498 instanceof cljs.core.Keyword))?G__52498.fqn:null);
switch (G__52498__$1) {
...
var map__52514 = options;
var map__52514__$1 = (((((!((map__52514 == null))))?(((((map__52514.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52514.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__52514):map__52514);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52514__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52514__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52514__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52514__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__52515 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52515,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52515,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52515,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52515,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52515,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52515,(5),null);
...
var o__52000__auto__ = f;
return (o__52000__auto__["getBasis"]).call(o__52000__auto__);
});
/**
...
}catch (e52524){var _e__52007__auto__ = e52524;
...
var G__52635 = (obj[cljs.core.first(path)]);
var G__52636 = cljs.core.rest(path);
obj = G__52635;
path = G__52636;
continue;
} else {
...
var _STAR_ = (function (accum,p__52539){
var vec__52540 = p__52539;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52540,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52540,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__52546){
var vec__52547 = p__52546;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52547,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52547,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52547,(2),null);
...
var post_process = (function (p__52554){
var vec__52556 = p__52554;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52556,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52556,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52551_SHARP_){
return (obj[cljs.core.first(p1__52551_SHARP_)]);
}),sorted_matches);
