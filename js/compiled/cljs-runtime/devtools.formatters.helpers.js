...
var G__52600 = devtools.prefs.pref(v);
v = G__52600;
continue;
} else {
return v;
...
}catch (e52571){var _e__52007__auto__ = e52571;
return false;
}})();
...
}catch (e52575){var _e__52007__auto__ = e52575;
return false;
}})();
...
}catch (e52577){var _e__52007__auto__ = e52577;
return false;
}}
}
});
...
var vec__52584 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52584,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52584,(1),null);
...
return cljs.core.some((function (p1__52591_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__52591_SHARP_);
}),template);
});
