...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__90296_SHARP_){
return (!(cljs.core.empty_QMARK_(p1__90296_SHARP_)));
...
return cljs.core.zipmap(cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__90297_SHARP_){
return revert.tokens.token_symbol(p1__90297_SHARP_,tokens);
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__90298_SHARP_){
return (!(cljs.core.empty_QMARK_(p1__90298_SHARP_)));
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__90299_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(p1__90299_SHARP_,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"token","token",-1211463215),token], null));
...
return cljs.core.zipmap(cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__90300_SHARP_){
return revert.tokens.token_symbol(p1__90300_SHARP_,tokens);
}),new cljs.core.Keyword(null,"token","token",-1211463215)),claimed),cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"qty","qty",155560951),claimed));
});
...
var deposit_flows = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__90301_SHARP_){
return revert.lp_positions.deposit_flow(p1__90301_SHARP_,tokens,blocks_ts);
}),new cljs.core.Keyword(null,"mints","mints",-278208376).cljs$core$IFn$_invoke$arity$1(lp_position));
var gas_flows = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__90302_SHARP_){
return revert.lp_positions.gas_flow(p1__90302_SHARP_,tokens,blocks_ts);
}),new cljs.core.Keyword(null,"mints","mints",-278208376).cljs$core$IFn$_invoke$arity$1(lp_position));
...
var withdrawal_flows = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__90303_SHARP_){
return revert.lp_positions.withdrawal_flow(p1__90303_SHARP_,tokens,blocks_ts);
}),new cljs.core.Keyword(null,"burns","burns",1858509067).cljs$core$IFn$_invoke$arity$1(lp_position));
var gas_flows = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__90304_SHARP_){
return revert.lp_positions.gas_flow(p1__90304_SHARP_,tokens,blocks_ts);
}),new cljs.core.Keyword(null,"burns","burns",1858509067).cljs$core$IFn$_invoke$arity$1(lp_position));
...
var flows = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__90305_SHARP_){
return revert.lp_positions.reward_flow(p1__90305_SHARP_,tokens,blocks_ts);
}),paid_rewards);
return flows;
});
...
}catch (e90306){if((e90306 instanceof Error)){
var err = e90306;
...
var relevant_flows = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__90307_SHARP_){
return cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"deposits","deposits",-1544951296),null,new cljs.core.Keyword(null,"withdrawals","withdrawals",-1952766911),null,new cljs.core.Keyword(null,"gas-costs","gas-costs",-1172157904),null], null), null),new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__90307_SHARP_));
}),flows);
...
}catch (e90308){if((e90308 instanceof Error)){
var err = e90308;
...
revert.lp_positions.assets_value_all = (function revert$lp_positions$assets_value_all(lp_positions,pools,tokens){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(bignumber.core._PLUS_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__90309_SHARP_){
return revert.lp_positions.assets_value(p1__90309_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(pools,new cljs.core.Keyword(null,"address","address",559499426).cljs$core$IFn$_invoke$arity$1(p1__90309_SHARP_)),tokens);
}),lp_positions));
});
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(bignumber.core._PLUS_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__90310_SHARP_){
return revert.lp_positions.total_rewards(p1__90310_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(pools,new cljs.core.Keyword(null,"address","address",559499426).cljs$core$IFn$_invoke$arity$1(p1__90310_SHARP_)),tokens);
}),lp_positions));
});
revert.lp_positions.pool_pnl_all = (function revert$lp_positions$pool_pnl_all(lp_positions,pools,tokens){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(bignumber.core._PLUS_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__90311_SHARP_){
return revert.lp_positions.pool_pnl(p1__90311_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(pools,new cljs.core.Keyword(null,"address","address",559499426).cljs$core$IFn$_invoke$arity$1(p1__90311_SHARP_)),tokens);
}),lp_positions));
});
revert.lp_positions.total_pnl_all = (function revert$lp_positions$total_pnl_all(lp_positions,pools,tokens){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(bignumber.core._PLUS_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__90312_SHARP_){
return revert.lp_positions.total_pnl(p1__90312_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(pools,new cljs.core.Keyword(null,"address","address",559499426).cljs$core$IFn$_invoke$arity$1(p1__90312_SHARP_)),tokens);
}),lp_positions));
});
...
var blocks = cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(mint_blocks,burn_blocks,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([reward_blocks], 0));
return blocks;
});
