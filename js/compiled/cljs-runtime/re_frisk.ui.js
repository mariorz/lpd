...
return (function (){
reagent.dom.unmount_component_at_node(app);
...
return (function (){
var map__63809 = new cljs.core.Keyword(null,"opts","opts",155075701).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(re_frisk.db.tool_state));
var map__63809__$1 = (((((!((map__63809 == null))))?(((((map__63809.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63809.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__63809):map__63809);
var ext_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63809__$1,new cljs.core.Keyword(null,"ext_height","ext_height",-46169089));
var ext_width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63809__$1,new cljs.core.Keyword(null,"ext_width","ext_width",925500566));
...
return reagent.dom.render.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk.ui.inner_view,re_frame_data], null),div);
});
