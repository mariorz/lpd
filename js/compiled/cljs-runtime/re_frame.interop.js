...
return [(function (){var pred__55853 = cljs.core.instance_QMARK_;
var expr__55854 = reactive_val;
if(cljs.core.truth_((pred__55853.cljs$core$IFn$_invoke$arity$2 ? pred__55853.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__55854) : pred__55853.call(null,reagent.ratom.RAtom,expr__55854)))){
return "ra";
} else {
if(cljs.core.truth_((pred__55853.cljs$core$IFn$_invoke$arity$2 ? pred__55853.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__55854) : pred__55853.call(null,reagent.ratom.RCursor,expr__55854)))){
return "rc";
} else {
if(cljs.core.truth_((pred__55853.cljs$core$IFn$_invoke$arity$2 ? pred__55853.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__55854) : pred__55853.call(null,reagent.ratom.Reaction,expr__55854)))){
return "rx";
} else {
if(cljs.core.truth_((pred__55853.cljs$core$IFn$_invoke$arity$2 ? pred__55853.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__55854) : pred__55853.call(null,reagent.ratom.Track,expr__55854)))){
return "tr";
} else {
return "other";
}
